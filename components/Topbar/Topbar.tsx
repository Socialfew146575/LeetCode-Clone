...
const Topbar: React.FC<TopbarProps> = ({ problemPage }) => {
  ...
  const handleProblemChange = (isForward: boolean) => {
    const { order } = problems[params.pid] as Problem;
      ...
      >
        ...
        {problemPage && (
          <div className="flex items-center gap-4 flex-1 justify-center">
            <div
              className="flex justify-center items-center rounded bg-dark-fill-3 hover:bg-dark-fill-2 h-8 w-8 cursor-pointer"
